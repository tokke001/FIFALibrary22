...
Namespace Rx3
    Public Class QuadIndexBuffer
        ...
        Private _IndexData As New List(Of UInteger)
        ...
        Public Property IndexData As List(Of UInteger)
            ...
            Set
                _IndexData = Value
                Me.Header = New QuadIndexBufferHeader(_IndexData)
            End Set
        End Property

        Public Property Header As New QuadIndexBufferHeader(Me.IndexData)
