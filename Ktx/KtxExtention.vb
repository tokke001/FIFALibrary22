...
Namespace Ktx
    Public Module KtxExtensions

        <System.Runtime.CompilerServices.Extension>
        Public Sub FromRawImages(ByVal m_KtxFile As KtxFile, ByVal RawImages As RawImage()())  ', ByVal TextureType As ETextureType, ByVal TextureFormat As ETextureFormat, ByVal m_Width As UInteger, ByVal m_Height As UInteger) As DdsFile
            ...
            If RawImages(0)(0).TextureFormat.IsCompressedFormat Then 'GraphicUtil.IsCompressedFormat(RawImages(0)(0).TextureFormat) Then
                ...
                m_KtxFile.Header = KtxHeader.InitializeCompressed(RawImages(0)(0).Width, RawImages(0)(0).Height, GlFormat.InternalFormat, GlFormat.GlFormat)
            Else

                m_KtxFile.Header = KtxHeader.InitializeUncompressed(RawImages(0)(0).Width,
            ...
            For i As UInteger = 0 To NumMipMaps - 1
                m_KtxFile.MipMaps.Add(New KtxMipmap(0, 0, 0, NumFaces))
            Next i
            ...
            For f As Integer = 0 To NumFaces - 1
                ...
                For i As Integer = 0 To NumMipMaps - 1
                    ...
                    If f = 0 Then
                        m_KtxFile.MipMaps(i) = New KtxMipmap(CUInt(encoded.Length), RawImages(f)(0).Width, RawImages(f)(0).Height, NumFaces)
                    End If

                    m_KtxFile.MipMaps(i).Faces(f) = New KtxMipFace(encoded, RawImages(f)(0).Width, RawImages(f)(0).Height)
                Next i
            ...
            m_KtxFile.Header.NumberOfFaces = NumFaces
            m_KtxFile.Header.NumberOfMipmapLevels = NumMipMaps

        End Sub

        <System.Runtime.CompilerServices.Extension>
        Public Function ToRawImages(FileKtx As KtxFile) As RawImage()()
